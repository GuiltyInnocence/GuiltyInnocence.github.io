schemes['SI100B'] = {
    ...
    subj: ['SI100B', 'python', 'matlab'],
    //至少1个有关第一个学科的 字面上可以解释为物理结构的词
    stru: ['pip','git','matlab','multisim'],
    //至少9个有关第一个学科的名人名言
    cele: [
        ['leeee', '语言的意义和作用是什么？'],
        //['扣扣群里', 'SI100B一年比一年糟糕'],
		...
		['TA', 'I cannot tell you exactly what functions are forbidden'],
		['SP_hw1','you are asked to search the Internet (google, bing, baidu, etc.)']
    ],
    //至少3个有关第一个学科的思想（主义）
    ...
    prop: ['学术诚信', '内卷', 'GPA'],
    //至少6个有关第一个学科的概念
    conc: ['shanghaitech', '入门指北', 'piazza', 'gradescpoe', '爆零', 'gitlab', 'ddl','ImageProcessing'],
    init: function () {
        shuffle(this.stru);
        shuffle(this.cele);
        shuffle(this.prin);
